                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="font-weight:bold;font-size:12px">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="coordinatorlist.php">Branch Coordinators</a></li>
                        <li><a href="studentpdf.php">Question Papers Pattern for Session 2015-16</a></li>
                        <!--<li><a href="download.php">Question Bank</a></li>-->
                        <li><a href="suggestion.php">Suggestions & Feedback</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                
                <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user fa-fw"></i>Login/Register<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href='registration_faculty_new.php'><i class="fa fa-sign-out fa-fw"></i>Faculty Registration</a>
                        <li class="divider"></li>
                        <li><a href="#" data-toggle="modal" data-target="#faclogin"><i class="fa fa-sign-out fa-fw"></i>Faculty Login</a>
                        <li class="divider"></li>
                        <!--<li><a href="#" data-toggle="modal" data-target="#clglogin"><i class="fa fa-sign-out fa-fw"></i>College Login</a>
                        <li class="divider"></li>-->
                        <li><a href="#" data-toggle="modal" data-target="#faclogin"><i class="fa fa-sign-out fa-fw"></i>Branch Co-ordinator Login</a>
                        <li class="divider"></li>
                        <li><a href="#" data-toggle="modal" data-target="#faclogin"><i class="fa fa-sign-out fa-fw"></i>Controller of Examination Login</a>
