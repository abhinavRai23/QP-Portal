...
if(isset($_POST['registerNew'])) {
	if($_SESSION['captcha']!=$_POST['captcha'])
		{
			echo "<h2 style='text-align:center;color:red;'>Invalid Captcha</h2>";
			die();
		}
$target_dir = "fimages/";
...
/*...............PERSONAL DETAILS..................*/
	...
	$name = $mister1.' '.htmlentities($_POST['name']);
				...
				<table style="width:100%;">
						<tr>
							<div class="form-group">
								...
								<td>
									<select class="form-control" name="collegeId" id="personal-fieldCol" onchange="selectdept();">
						...
						<tr>
							<div class="form-group">
								...
								<td>
									<input class="form-control" type="text" name="phone" id="phone" style="min-width:37%;" onkeyup="validate(this,'num');"  maxlength="10" minlength="10" onfocusout="validatemob(this);" required>
								</td>
							</div>	
						</tr>
						<tr>
							<div class="form-group">
								...
								<td>
									<input class="form-control" type="email" name="email" id="email" style="min-width:37%;text-transform: lowercase;"  onfocusout="validateEmail(this);" required >
								</td>
							</div>	
						</tr>
						<tr>
							<div class="form-group">
								...
								<td>
									<input onpaste="return false" class="form-control" type="email" name="confirmmail" id="confirmmail" style="min-width:37%;text-transform: lowercase;" onpaste="return false"; onkeyup="validateConfirmEmail1(this);" onfocusout="validateConfirmEmail(this);"   required>
								</td>
							</div>	
						</tr>
                    	...
                    	<table style="width:100%;">
							...
							<tr>
								<div class="form-group">
									...
									<td>
	                                    <input class="form-control" type="text" name="accountNo" id="acc_no" style="min-width:37%;max-width:200px;" onkeyup="validate(this,'num');">
									</td>
								</div>	
							</tr>
							<tr>
		                ...
		                <table class="table table-bordered">
		                    ...
		                    <tbody id="technical">
		                        <tr>
		                            ...
		                            <td><input class="form-control tbl" type="text" name="passingyr[]" id="passingyr" placeholder="" style="" required  onkeyup="validate(this,'num');" maxlength="4"></td>
		                ...
		                <table class="table table-bordered">
		                    ...
		                    <tbody id="technicalskill">
		                     <tr>
		                        	...
		                        	<input type="button" class="btn btn-success pull-right" style="padding:4px 8px;" onclick="training()" value="Add Fields">
		                        	<table><tr>
							<div class="form-group">
								<td>
									<label>Captcha:</label>
							...
							<div class="form-group">
								...
								<td>
								<input type="text" size="6" name="captcha" id="captcha" required>
								</td>
							</div>	
							</tr></table>
...
function validateEmail(obj){
    var email=obj.value;
	var conemail=document.getElementById('confirmmail').value;
	 var n=conemail.length;
	 type="email";
	  var n1=email.length;
	  if(n1>0){
	 var retur= ValidateEmailregax(email);
	}
	 // alert(retur);
	...
	$.ajax({
        type:"POST",
 		url:"filter.php",
 		data:{emailsending:email,typee:type},
 		success:function(data){
     
                 if(data=='1'){
                           swal("you can not register yourself with this email address, this email address aleredy exist");
                           obj.value='';
                           document.getElementById('confirmmail').value='';
                   }
                   else{
                   	  obj.value=data;
                   }
...
function ValidateEmailregax(mail)   
{  
