...
$sql="INSERT INTO paper_pattern (setId,subject,A,B,C,controller,sdate,sem,TA,TB,TC,outOfA,outOfB,outOfC,totalMarks,creater)VALUES(:setId,:subject,:a,:b,:c,'0','0',:sem,:TA,:TB,:TC,:outOfA,:outOfB,:outOfC,:Tmark,'0')";
$run=$conn->prepare($sql);
