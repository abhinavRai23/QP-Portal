<?php
    ...
    echo '<form id="paperSetView" style="visibility:hidden" method="POST" action="../coordinator/paper.php">
...
<div class="panel-body" id="panel-body">
    <?php if($pattern_detail['controller']=='1'){echo "<h5 align='center'><b>Paper has been sent to controller.</h5>";die();} ?>
    <div class="col-sm-3">
...
echo '
        <div class="panel panel-default">
          ...
          echo '<div class="col-sm-9" style="border-left:1px solid #929292;min-height:500px;"><h4 align="center"><b style="color: #7B7B7B;">'.$subjectName.'('.$sub.')</b>
                ...
                </h4><iframe name="my_iframe" frameborder="0" width="99%" style="position: absolute; height: 100%;"  id="secondPanel"></iframe></div>   ';  
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <span id="chooseMethodBank" class="btn btn-success" style="width:90%;" align="center">Choose From Question Bank</span>
                </center>
            </div>
          </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#chooseMethodBank").click(function(){
      $.ajax({
                 ...
                 success:function(result){
                  ...
                  $("#secondPanel").attr(src="getQuestionForPaper.php");
    ...
    $("#createMethodNew").click(function(){
      $("#hidden").html('<form name="hiddenForm" id="hiddenForm" method="POST" action="../uploads/paperEdit.php" target="my_iframe"><input type="hidden" name="fromId" value="'+$("#questionMethodID").val()+'"></form>');
      $("#hiddenForm").submit();
      $("#paperMethod").modal("hide");
