	...
	<div class="row">
		<div class="col-sm-6">
			<form role="form" class="form-inline" method="POST" action="setCreation.php">
						...
						<div class="form-group">
							...
							<td>
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="purpose"value="S" checked="">Selected Question
                                </label>
                                </div>
                                <div class="form-group" style="padding-left:25%;">
                                <label class="radio-inline">
                                    <input type="radio" name="purpose" value="C">All
                                </label>
                            	</div>
                            </td>
						</div>	
				...
				<center><input type="submit" class="btn btn-md btn-success btn-block" value="Submit" name="createSet" style="width:25%;"></center>
			</form>
		</div>
	</div>
