...
$message = $receiverName.", this is to notify you regarding disapproval of your subject ".$subName." (".$subId.") by Coordinator. You are notified here that you are no longer approved to upload question papers for the above approved subject.<br> Thanking you<br>APJAKTU";
