...
function myfunction(sem,branch){

 $.ajax({
             
             type:"POST",
             url:"view_showQuestionSet.php",
...
<div class="panel-heading" align="center" style="font-size:28px;padding-bottom:2%">
            View Question Paper Set<br><br>
</div>
<div class="panel-body" id="panel-body">
	<div class="row">
	<div class="col-md-3	"></div>
		<div class="col-sm-6">
			<form role="form" class="form-inline" method="POST" action="view_select_sub_setQuestionBank.php" id="myform">
...
<?php
 	 if(isset($_POST['redirectPage'])) 
 	 	echo "<script>myfunction('".$_POST['sem']."','".$_POST['branchId']."');</script>";
 	 	?>
