...
<script type="text/javascript">
	$(document).ready(function(){
		$("#downloadPDF").click(function(){
			$("#myhiddenForm").html('<form id="pdfForm" action="../download/pdf/question_bank.php" method="POST" target="_blank"><input type="hidden" name="purpose" value="D"><input type="hidden" name="mypdfdata" id="mypdfdata" value""><input type="hidden" name="mypdffilename" value="sets"></form>');
...
<!--
		<div style='border:1px solid black;border-radius:4px;font-size:14px;font-weight:bold;'><center>(Following Paper ID and Numbers to be filled in your Answer books)</center>


	<div style='padding:5px'><div style='width:28%;display:inline-block;background-color:black;color:white;padding:2px;'>Paper ID:
	...
	<div style='display:inline-block'>Roll No.:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table border='1'><tbody><tr><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;</td></tr></tbody></table></div></div></div>-->