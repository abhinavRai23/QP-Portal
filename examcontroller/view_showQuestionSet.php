...
$run=$obj->fetchQuestionSet($branch,$sem,$conn);
echo'
                  ...
                  echo'           <tbody>
                                <tr>
                                    ...
                                    if($p['creater']=='1')
                                    {
                                      ...
                                      echo "Coordinator</td><td>$p[sdate]";
                                    }
                                    echo "</td><td>";
                                    ...
                                    ';
                                    if($p['student']=='0')
                                    echo '<td><button  id="V'.$buttonId.'" class="btn btn-success" onclick="viewStudent(\''.$p['setId'].'\',\''.$p['subject'].'\',\''.$sem.'\')">Allow</button></td>';
                                  else if($p['student']=='1')
                                    echo '<td><button  id="V'.$buttonId.'" class="btn btn-info" onclick="viewStudentD(\''.$p['setId'].'\',\''.$p['subject'].'\',\''.$sem.'\')">Disallow</button></td>';
                               echo ' </tr>
                            </tbody>';
