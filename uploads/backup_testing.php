...
echo '<td class="s_no">'.$num.'</td>
	...
	<div class="col-md-6">
        ...
        if($type=='Q')
		  ...
		  ?><b>
        <button type="button" class="btn btn btn-success">&nbsp;</button>&nbsp;Uploaded&nbsp;&nbsp;
        <button type="button" class="btn btn btn-danger">&nbsp;</button>&nbsp;Not-uploaded&nbsp;&nbsp;
        <button type="button" class="btn btn btn-default" style="background-color:#4263E4;">&nbsp;</button>&nbsp;Have to save  
